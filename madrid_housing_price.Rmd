...
### Outlier Analysis using Histogram for Numerical Data


#### 1. Analysis on building area in square meter (`sq_mt_built` column)
```{r echo=FALSE, results='hold'}
...
#### 2. Analysis on number of room(s) and bathroom(s) per listing (`n_rooms` & `n_bathrooms`column)
...
#### 3. Analysis on Buy Price and Buy Price per Area
...
#### 4. Define Top 10 districts with highest number of listed properties?
...
#### 5. Which are the top 10 districts with highest average (median) of **buying price per area**?
...
#### 6.Correlation of other variables to **buying price per area**, which variable have strongest correlation with it?
...
#### 7. If a customer, with single/unmarried status & in their early employement year as an junior engineer at AECOM Madrid, ask for your recommendation as a real-estate consultant to buy his 1st property, what are your suggestions and why?
...
#### 8. If a family of 4 looking for a house for them to settle down and stay for a long term, both parents work for quite some years already, what would be your recommendation as a real estate consultant?
...
#### 9. Could you define the characteristic of certain area or neighborhoods based on the property profile listed in your dataset?
